...
function alteraCategoriaDaSolicitacao(categoria) {
    if (categoria == "") {
        ...
        $("#divCombustivel, #divCombustivelDois").hide();
        ...
        $("#divAnexar, #divDocsAnexados, #divCombustivel, #divCombustivelDois").show(); 
        $("#prefixo").closest("div").show(); 
        $("#CODIESPE").val(1);

    } else if (categoria == "PA" || categoria == "PA (Ponto de Abastecimento)") {
        $(".inputMA, .inputOutros").closest("div.inputGroup").hide();
        $(".inputPA").closest("div.inputGroup").show();
        $("#divAnexar, #divDocsAnexados").hide();
        $("#prefixo").closest("div").show(); 
        $("#CODIESPE").val(5);
